# Script to count ABBA/BABA sites across hedgehog genome using modified script of Simon Martin,
# available here: https://github.com/simonhmartin/genomics_general
# a known phylogeny of Erinaceus genus is (((E. conoclor)(E. roumanicus))(E. europaeus))
...
freq_table <- read.table("all2.tsv", header=T, as.is=T)
